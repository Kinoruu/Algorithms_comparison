...
cv2.imwrite('image_sift.jpg', output)
...
cv2.imwrite('image2_sift.jpg', output)
...
cv2.imwrite('image_brief.jpg', output)
...
output = cv2.drawMatches(img1 = image3,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image2_brief.jpg', output)
...
output = cv2.drawMatches(img1 = image1,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image_orb.jpg', output)
...
output = cv2.drawMatches(img1 = image3,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image2_orb.jpg', output)
...
output = cv2.drawMatches(img1 = image1,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image_kaze.jpg', output)
...
image4 = cv2.imread(filename = 'image4.jpg',
                   flags = cv2.IMREAD_GRAYSCALE)
kaze = cv2.KAZE_create()
keypoints4, descriptors3 = kaze.detectAndCompute(image3, None)
...
output = cv2.drawMatches(img1 = image3,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image2_kaze.jpg', output)
...
output = cv2.drawMatches(img1 = image1,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image_akaze.jpg', output)
...
output = cv2.drawMatches(img1 = image3,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image2_akaze.jpg', output)
...
output = cv2.drawMatches(img1 = image1,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image_brisk.jpg', output)
...
output = cv2.drawMatches(img1 = image3,
                        ...
                        outImg = None,
                        flags = cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
cv2.imwrite('image2_brisk.jpg', output)